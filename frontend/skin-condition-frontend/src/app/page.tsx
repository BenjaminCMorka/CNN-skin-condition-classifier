...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex flex-col">
      ...
      <footer className="text-gray-900 py-3 text-center bg-gradient-to-t from-white via-white to-blue-50 border-t border-gray-200">
        <p className="text-base mb-1 font-semibold">Connect with me</p>
        <div className="space-x-6 flex justify-center">
          <Github className="h-9 w-9 text-gray-800 hover:text-black transition-colors" />
          <Linkedin className="h-9 w-9 text-blue-600 hover:text-blue-700 transition-colors" />
        </div>
      </footer>
    </div>
  );
